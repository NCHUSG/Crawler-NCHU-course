...
test:
	...
	python3 ./fallback/crawler/PE.py https://onepiece.nchu.edu.tw/cofsys/plsql/crseqry_all fileName.json 1 7 B 4 0 H 

	python3 ./fallback/crawler/general_EDU.py https://onepiece.nchu.edu.tw/cofsys/plsql/crseqry_gene fileName.json E F G 3 8
